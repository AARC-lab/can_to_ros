    ...
    if vin_details['Make'] == 'TOYOTA':
        if vin_details['Model'] == 'RAV4':
            ...
            if int(vin_details['ModelYear']) >= 2021:
                ...
                dbcfile = user_home + '/strym/strym/dbc/toyota_rav4_2021.dbc'
            elif int(vin_details['ModelYear']) == 2020:
                dbcfile = user_home + '/strym/strym/dbc/toyota_rav4_2020.dbc'
            elif int(vin_details['ModelYear']) == 2019:
                dbcfile = user_home + '/strym/strym/dbc/toyota_rav4_2019.dbc'
            if 'HV' in vin_details['Trim']:
                # dbcfile = '/Users/mnice/Documents/GitHub/strym/strym/dbc/toyota_rav4_hybrid.dbc'
                dbcfile = user_home + '/strym/strym/dbc/toyota_rav4_hybrid.dbc'
    ...
    if vin_details['Make'] == 'NISSAN':
        if vin_details['Model'] == 'Rogue':
            ...
            if int(vin_details['ModelYear']) >= 2021:
                ...
                dbcfile = user_home + '/strym/strym/dbc/nissan_rogue_2021.dbc'
                # dbcfile = user_home + '/strym/strym/dbc/nissan_rogue_experimental.dbc'

    if vin_details['Make'] == 'HONDA':
        if vin_details['Model'] == 'Pilot':
            jsonfile = 'honda_pilot.json'
            dbcfile = user_home + '/strym/strym/dbc/honda_pilot_2017.dbc'
    try:
